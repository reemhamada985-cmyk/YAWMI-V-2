...
public class AdhanService extends Service{
 ...
 @Override public int onStartCommand(Intent i,int flags,int startId){try{if(player!=null){player.stop();player.release();}player=MediaPlayer.create(this,R.raw.adhan);if(player!=null){player.setOnCompletionListener(mp->stopSelf());player.start();}}catch(Exception e){stopSelf();}return START_NOT_STICKY;}
